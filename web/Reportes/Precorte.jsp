...
<html>
    <head>
        ...
        <%
            ...
            String idOp = request.getParameter("pt");
            ...
            if (idOp == null) {
                ...
                response.setHeader("Content-Disposition", "attachment;filename=\"CorteCuentas" + d.getTipoEvento() + "" + dia + ".xls\"");
            }
            ...
            <div class="navbar-inner">
                <div class="container">
                    ...
                    <table ><tr><td>
                                ...
                                <a class="btn-large btn btn-danger navbar-form pull-righ" href="../linkAdmin.jsp" style="height:40px">Regresar</a>
                            </td></tr>
