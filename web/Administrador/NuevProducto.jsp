                ...
                <div id="editarprod">
                    <table><tr><td>
                                <form class="nuevo" id="nuevobotella">
                                    ...
                                    Estado <br>Activo <input type="radio" name="estado" value="1" checked=""> Inactivo <input type="radio" name="estado" value="0"><br>
                                    <input type="submit" value="Enviar">
                                </form></td><td>
                                <form class="nuevo" id="nuevocopa">
                                    Nombre:<input type="text" id="num2" name="nompro" required=""> <br>
                                    Tipo<select name="tipo" required="">
                                        <option value="Copa">Copa</option>
                                        <option value="Botella">Botella</option>
                                    ...
                                    Tamaño<input type="text" name="tamano" onkeypress="return isNumberKey(event)" value="30" required> <br>
                                    <select name="medida" required="">
                                        <option value="">Medida</option>
                                        <option value="lt">lt</option>
                                        <option value="ml">ml</option>
                                    ...
                                    Precio<input type="text" name="precio" onkeypress="return isNumberKey(event)"  value="30" required> <br>
                                    <select name="categoria" required="">
                                        <option value="">Categoría</option>
                                        <%


                                            List resc = dao.getFiltro();
                                            Iterator itrc = resc.iterator();
                                            while (itrc.hasNext()) {
                                                Categoria c = (Categoria) itrc.next();
                                                out.println("<option value='" + c.getIdCategoria() + "'>" + c.getIdCategoria() + "</option>");
