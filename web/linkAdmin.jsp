...
//out.println(d);
            ...
            String tipoadmin = (String) sesion.getAttribute("SusperUsuario");
    ...
    <body>
        ...
        <div>
                    ...
                    <div class="container">
                        ...
                        <div class="nav-collapse collapse">
                            <div class="navbar-form pull-right">
                                <div class="navbar-form pull-right">
                                    <%if(tipoadmin.equals("Adminpv")){%>
                                    <a href="Menu.jsp" class="btn btn-large btn-warning"><--Regresar</a>
                                     <%}else{%>
                                      <a href="Administrador/Menu.jsp" class="btn btn-large btn-warning"><--Regresar</a>
                                     <%}%>
            ...
            <table style="text-align:center">
                ...
                <tr>  <td>
                        <h5>Corte</h5>
                    </td><td><a href="Reportes/Cuentas.jsp" class="thumbnail">
                            <img data-src="holder.js/300x200" src="images/descargar.png" class="img" alt="">
                        </a></td><td>
                        <a href="Reportes/Cuentas.jsp?pt=1" class="thumbnail verbtn">
                            <img data-src="holder.js/300x200" src="images/consultar.png" class="img" alt="">
                        </a>
                    </td>
                    <td>
