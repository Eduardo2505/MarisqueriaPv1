...
// Imprime tiket
                    ...
                    while (itra.hasNext()) {
                        ...
                        if (a.getTipo().equals("pakete")) {
                            pakete = "Activo";
                        }
                        estadoita = "Activo";


                        resultado.append(a.getProducto() + " " + a.getMedida() + " -> " + a.getCantidad() + " Cat\n");
                        ...
                        while (itr.hasNext()) {
                            ...
                            resultado.append("_____(" + vcx.getProducto() + " " + vcx.getMedida() + "-> " + vcx.getCantidad() + " Cant)\n\n");
                    ...
                    while (itrax.hasNext()) {
                        ...
                        resultado.append(a.getProducto() + " " + a.getMedida() + " -> " + a.getCantidad() + " Cant\n");
                    ...
                    String tiket = dao.ImprimirComanda(nomMesero.toUpperCase(), clave, mesaCuenta + "\n#" + idMesa, idComanda, fechaAc, horaAc, man.getTipo().toUpperCase(), man.getAutorizacion(), man.getObserva(), resultado.toString(), estadoita, imprebarra,pakete);
