 ...
 * @author Eduardopc
 */
public class actualizarNormal extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet actualizarNormal</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet actualizarNormal at " + request.getContextPath() + "</h1>");
