...
public class ProductoDaoImpl implements ProductoDao {
    ...
    @Override
    public void actulizarPromo(String idPro, String estado) {
        Session session = HibernateUtil.getSessionFactory().openSession();
    ...
    @Override
    public void actulizar(String idPro, String estado, String op, String medida) {
        Session session = HibernateUtil.getSessionFactory().openSession();
        ...
        try {
            tx = session.beginTransaction();
            producto = (Producto) session.get(Producto.class, idPro);
            producto.setTipo(estado);
            producto.setOpcion(op);
