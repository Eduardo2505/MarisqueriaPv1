...
public class Mesa_ventaDaoImpl implements Mesa_ventaDao {
    ...
    public static void main(String[] args) {
        ...
        int idDia=26;
        List resmv = daomv.getMesaVenta("Activo", "20150529124210121", idDia);
        ...
        while (itrmv.hasNext()) {
            ...
            System.out.println(" <li class='ui-state-default ocupado'><a  href='SessionIdMesaComanda?idMesaVenta=" + mesasv.getIdMesaVenta() + "&idComanda=VER&tipo=venta&observa=-&autorizacion=-&nombremesa=" + m.getIdMesaCapturada().replace(" ", "-") + "' class=\"btnli\" ><br><h1>" + m.getIdMesaCapturada() + "</h1><br><h4>Personas Aprox:" + mesasv.getPersonasAprox() + "</h4></a></li> ");
