...
public class EmpleadoDaoImpl implements EmpleadoDao {
    ...
    public Empleado Login(Empleado empleado) {
        ...
        try {
            ...
            String sql = "select u from Empleado u where mail=:email and passEmail=:pass";
    ...
    public List getFiltro() {
        ...
        try {
            ...
            Query q = session.createQuery("From Empleado as empleado where idpuesto=12 or idpuesto=5 or idpuesto=1 or idpuesto=8 or idpuesto=22 or idpuesto=2 or idpuesto=3 or idpuesto=23 order by Empleadocol ");
            empleados = (List<Empleado>) q.list();
