...
<%
    ...
    String perlanegra = jdomdao.Buscar(rutita, "estado", "promo_perla");
    String promo_laborguini = jdomdao.Buscar(rutita, "estado", "promo_laborguini");
...
<table class="table table-striped">
    <tr>
        ...
        <% if (promo_hene.equals("Activo")) {
                ...
                StringBuffer pro = new StringBuffer();
                pro.append("IN ('BUR-ON23','BUR-ON24','BUR-ON25','BUR-ON26','BUR-ON27')");
        %>
        <td>
            <h4>Buerros</h4>
            <h5><%=limiteb%></h5>
            <form class="enviarfrom">
                ...
                <input type="hidden" name="idventa" value="<%=idventa%>">
                <select name="productos" required="" class="form-control">
                    <option value="BUR-ON23">Burro Vaca</option>
                    <option value="BUR-ON24">Burro 4 Vientos</option>
                    <option value="BUR-ON25"> Burro Flanders</option>
                    <option value="BUR-ON26"> Burro Alambrado</option>
                    <option value="BUR-ON27">Burro Anti-Vaca</option>
    ...
    <tr><td>
            ...
            <% if (perlanegra.equals("Activo")) {
                    String limitecomida = jdomdao.Buscar(rutita, "limite", "promo_perla");
                    String classcomida = jdomdao.Buscar(rutita, "clase", "promo_perla");
                    String id = jdomdao.Buscar(rutita, "id", "promo_perla");
                    StringBuffer procc = new StringBuffer();
                    procc.append("IN (");
            %>
            <h4>Vino Espumoso</h4>
            ...
            <form class="enviarfrom">
                ...
                <select name="productos" required="" class="form-control">
                    ...
                    <%
                        List list = jdomdao.mostrarPro(rutita, "perla");
                        for (int i = 0; i < list.size(); i++) {
    ...
    <tr><td>
            <% if (promo_laborguini.equals("Activo")) {
                    String limitecomida = jdomdao.Buscar(rutita, "limite", "promo_laborguini");
                    String classcomida = jdomdao.Buscar(rutita, "clase", "promo_laborguini");
                    String id = jdomdao.Buscar(rutita, "id", "promo_laborguini");
                    StringBuffer procc = new StringBuffer();
                    procc.append("IN (");
            %>
            <h4>PREPARADOS</h4>
            ...
            <form class="enviarfrom">
                ...
                <input type="hidden" name="idventa" value="<%=idventa%>">
                <select name="productos" required="" class="form-control">
                    <option value="MEN-ON50136">Con todo</option>

                    <%
                        List list = jdomdao.mostrarPro(rutita, "laborguini");
                        for (int i = 0; i < list.size(); i++) {
